...
CUDA_VISIBLE_DEVICES=1 nohup python eval_qd_model.py truthful_qa generation validation 2 --sub_one question --sub_two best_answer --task_idx 1 > ./log/generation.lb 2>&1 &
CUDA_VISIBLE_DEVICES=6 nohup python eval_qd_model.py truthful_qa multiple_choice validation 3 --sub_one question --sub_two mc1_targets --sub_three mc2_targets --task_idx 1 > ./log/multiple_choice.lb 2>&1 &
CUDA_VISIBLE_DEVICES=6 nohup python eval_qd_model.py gsm8k main test 2 --sub_one question --sub_two answer --task_idx 2 > ./log/main.lb 2>&1 &
CUDA_VISIBLE_DEVICES=7 nohup python eval_qd_model.py gsm8k socratic test 2 --sub_one question --sub_two answer --task_idx 2 > ./log/socratic.lb 2>&1 &
